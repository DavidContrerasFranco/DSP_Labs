...
% Butterworth
X_Butter_Rect = generalIIR_AyalaContreras(F_s, F_p, X_R, Fs, Rp, Rs, @buttord, @impinvar);
X_Butter_Hamm = generalIIR_AyalaContreras(F_s, F_p, X_H, Fs, Rp, Rs, @buttord, @impinvar);

% Chebyshev Type I
X_Chev1_Rect = generalIIR_AyalaContreras(F_s, F_p, X_R, Fs, Rp, Rs, @cheb1ord, @impinvar);
X_Chev1_Hamm = generalIIR_AyalaContreras(F_s, F_p, X_H, Fs, Rp, Rs, @cheb1ord, @impinvar);

% Chebyshev Type II
X_Chev2_Rect = generalIIR_AyalaContreras(F_s, F_p, X_R, Fs, Rp, Rs, @cheb2ord, @impinvar);
X_Chev2_Hamm = generalIIR_AyalaContreras(F_s, F_p, X_H, Fs, Rp, Rs, @cheb2ord, @impinvar);

% Elliptic
X_Ellip_Rect = generalIIR_AyalaContreras(F_s, F_p, X_R, Fs, Rp, Rs, @ellipord, @impinvar);
X_Ellip_Hamm = generalIIR_AyalaContreras(F_s, F_p, X_H, Fs, Rp, Rs, @ellipord, @impinvar);
