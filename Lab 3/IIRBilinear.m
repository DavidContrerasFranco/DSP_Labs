...
% Butterworth
X_Butter_Rect = generalIIR(F_s, F_p, X_R, Fs, Rp, Rs, @buttord, @bilinear);
X_Butter_Hamm = generalIIR(F_s, F_p, X_H, Fs, Rp, Rs, @buttord, @bilinear);

% Chebyshev Type I
X_Chev1_Rect = generalIIR(F_s, F_p, X_R, Fs, Rp, Rs, @cheb1ord, @bilinear);
X_Chev1_Hamm = generalIIR(F_s, F_p, X_H, Fs, Rp, Rs, @cheb1ord, @bilinear);

% Chebyshev Type II
X_Chev2_Rect = generalIIR(F_s, F_p, X_R, Fs, Rp, Rs, @cheb2ord, @bilinear);
X_Chev2_Hamm = generalIIR(F_s, F_p, X_H, Fs, Rp, Rs, @cheb2ord, @bilinear);

% Elliptic
X_Ellip_Rect = generalIIR(F_s, F_p, X_R, Fs, Rp, Rs, @ellipord, @bilinear);
X_Ellip_Hamm = generalIIR(F_s, F_p, X_H, Fs, Rp, Rs, @ellipord, @bilinear);
