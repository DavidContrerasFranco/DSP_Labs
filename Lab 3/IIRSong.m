...
% Butterworth
X_Butter_Song_B = songIIR(F_s, F_p, y, Fs, Rp, Rs, @buttord, @bilinear);
X_Butter_Song_I = songIIR(F_s, F_p, y, Fs, Rp, Rs, @buttord, @impinvar);

% Chebyshev Type I
X_Chev1_Song_B = songIIR(F_s, F_p, y, Fs, Rp, Rs, @cheb1ord, @bilinear);
X_Chev1_Song_I = songIIR(F_s, F_p, y, Fs, Rp, Rs, @cheb1ord, @impinvar);

% Chebyshev Type II
X_Chev2_Song_B = songIIR(F_s, F_p, y, Fs, Rp, Rs, @cheb2ord, @bilinear);
X_Chev2_Song_I = songIIR(F_s, F_p, y, Fs, Rp, Rs, @cheb2ord, @impinvar);

% Elliptic
X_Ellip_Song_B = songIIR(F_s, F_p, y, Fs, Rp, Rs, @ellipord, @bilinear);
X_Ellip_Song_I = songIIR(F_s, F_p, y, Fs, Rp, Rs, @ellipord, @impinvar);
